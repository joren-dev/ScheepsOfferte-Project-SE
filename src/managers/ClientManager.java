...
public class ClientManager {
    ...
    // Class members
    public static ArrayList<ClientType> client_types = new ArrayList<>();
    ...
    public static void add_client_type(final String type_name, final int discount) {
        for (final ClientType each : client_types) {
        ...
        client_types.add(new ClientType(type_name.toLowerCase(), discount));
    }

    public static void delete_client_type(final String type_name) {
        ClientManager.client_types.removeIf((x) -> x.get_type_name().equals(type_name.toLowerCase()));
    }

    public static void change_client_type(final String client_type_name) {
        Scanner scanner = new Scanner(System.in);

        Optional<ClientType> optional_client_type = ClientManager.client_types.stream().filter((client_type) -> client_type.get_type_name().equals(client_type_name.toLowerCase())).findFirst();
